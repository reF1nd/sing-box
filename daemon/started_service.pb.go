...
func (x *EBPFInboundDiagnostics) GetLocalBypassRuleSet() *EBPFBypassRuleSetDiagnostics {
	if x != nil {
		return x.LocalBypassRuleSet
	}
	return nil
}

func (x *EBPFInboundDiagnostics) GetSharedBypassRuleSet() *EBPFBypassRuleSetDiagnostics {
	if x != nil {
...
type EBPFBypassRuleSetDiagnostics struct {
	...
	PolicyVersion         uint64                                    `protobuf:"varint,3,opt,name=policyVersion,proto3" json:"policyVersion,omitempty"`
	ExpectedPolicyVersion uint64                                    `protobuf:"varint,4,opt,name=expectedPolicyVersion,proto3" json:"expectedPolicyVersion,omitempty"`
	RetryCount            uint64                                    `protobuf:"varint,5,opt,name=retryCount,proto3" json:"retryCount,omitempty"`
	BackendState          map[string]*EBPFBypassRuleSetBackendState `protobuf:"bytes,6,rep,name=backendState,proto3" json:"backendState,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *EBPFBypassRuleSetDiagnostics) Reset() {
	*x = EBPFBypassRuleSetDiagnostics{}
	mi := &file_daemon_started_service_proto_msgTypes[110]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EBPFBypassRuleSetDiagnostics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EBPFBypassRuleSetDiagnostics) ProtoMessage() {}

func (x *EBPFBypassRuleSetDiagnostics) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_started_service_proto_msgTypes[110]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EBPFBypassRuleSetDiagnostics.ProtoReflect.Descriptor instead.
func (*EBPFBypassRuleSetDiagnostics) Descriptor() ([]byte, []int) {
	return file_daemon_started_service_proto_rawDescGZIP(), []int{110}
}

func (x *EBPFBypassRuleSetDiagnostics) GetConsistent() bool {
	if x != nil {
		return x.Consistent
	}
	return false
...
func (x *EBPFBypassRuleSetDiagnostics) GetPending() bool {
	if x != nil {
		return x.Pending
	}
	return false
...
func (x *EBPFBypassRuleSetDiagnostics) GetPolicyVersion() uint64 {
	if x != nil {
...
func (x *EBPFBypassRuleSetDiagnostics) GetExpectedPolicyVersion() uint64 {
	if x != nil {
...
func (x *EBPFBypassRuleSetDiagnostics) GetRetryCount() uint64 {
	if x != nil {
		return x.RetryCount
	}
	return 0
...
func (x *EBPFBypassRuleSetDiagnostics) GetBackendState() map[string]*EBPFBypassRuleSetBackendState {
	if x != nil {
		return x.BackendState
	}
	return nil
...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\vnextRetryAt\x18\x10 \x01(\x03H\x02R\vnextRetryAt\x88\x01\x01\x12(\n" +
	...
	"\x05known\x18\x02 \x01(\bR\x05known\"\x98\x03\n" +
	"\x1cEBPFBypassRuleSetDiagnostics\x12\x1e\n" +
	"\n" +
	"consistent\x18\x01 \x01(\bR\n" +
	"consistent\x12\x18\n" +
	"\apending\x18\x02 \x01(\bR\apending\x12$\n" +
	"\rpolicyVersion\x18\x03 \x01(\x04R\rpolicyVersion\x124\n" +
	"\x15expectedPolicyVersion\x18\x04 \x01(\x04R\x15expectedPolicyVersion\x12\x1e\n" +
	"\n" +
	"retryCount\x18\x05 \x01(\x04R\n" +
	"retryCount\x12Z\n" +
	"\fbackendState\x18\x06 \x03(\v26.daemon.EBPFBypassRuleSetDiagnostics.BackendStateEntryR\fbackendState\x1af\n" +
	"\x11BackendStateEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.daemon.EBPFBypassRuleSetBackendStateR\x05value:\x028\x01\"\x8f\x01\n" +
...
var file_daemon_started_service_proto_goTypes = []any{
	...
	(*EBPFBypassRuleSetDiagnostics)(nil),      // 115: daemon.EBPFBypassRuleSetDiagnostics
...
var file_daemon_started_service_proto_depIdxs = []int32{
	...
	116, // 70: daemon.EBPFInboundDiagnostics.udpReplySockets:type_name -> daemon.EBPFUDPReplySocketDiagnostics
	117, // 71: daemon.EBPFInboundDiagnostics.counters:type_name -> daemon.EBPFCounters
