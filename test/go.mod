...
replace (
	...
	github.com/sagernet/sing-tun => github.com/reF1nd/sing-tun v0.8.12-0.20260729091938-d2199c3f8df2
)
...
require (
	...
	github.com/sagernet/tailscale v1.92.4-sing-box-1.13-mod.8.0.20260803091221-867c1f0012d9 // indirect
